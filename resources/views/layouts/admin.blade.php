        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('almacen/gastosa')}}"><i class="fa fa-circle-o"></i> Registro de Gastoss</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('almacen/platosv')}}"><i class="fa fa-circle-o"></i> Platos mas vendidos</a></li>
                <li><a href="{{url('salidas/personal')}}"><i class="fa fa-circle-o"></i> Bebidas mas vendidas</a></li>
              </ul>
            </li>
            <li>
              <a href="{{url('seguridad/usuario')}}">
                <i class="fa fa-users"></i> <span>Usuarios</span>
                <small class="label pull-right bg-green">US</small>
              </a>
            </li>
            <li>
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href=""><i class="fa fa-circle-o"></i> Salidas e Ingreso</a></li>
              </ul>
            </li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Panel del administracion</h3>
