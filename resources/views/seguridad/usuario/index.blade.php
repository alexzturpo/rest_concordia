...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Listado de Usuario  <a href="usuario/create"><button class="btn btn-success">Nuevo</button><a href="pdf/pdfingreso"><button class="btn btn-secondary">Reporte</button></a></a></h3>
